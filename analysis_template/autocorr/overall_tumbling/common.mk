...
data/fit/tau_1_exp.csv: ${SCRIPT_DIR}/fit_overall_tumbling.py data/acorr/tumbling_avg.csv
	mkdir -p data/fit/
	python3 $< \
...
data/acorr/tumbling_avg.csv: ${SCRIPT_DIR}/extract_inertia_tensor_vectors_autocorr.py
	mkdir -p data/acorr/
	python3 $< \
