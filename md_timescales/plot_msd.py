...
def get_translation_fit(path_to_msd, limit, output_directory): 
...
if __name__ == '__main__':	
    ...
    parser.add_argument('-i', '--path_to_msd', required=True)
    parser.add_argument('-lim', '--limit', type=int, required=True)
    parser.add_argument('-o', '--output_directory', default=os.getcwd())
    args = parser.parse_args()
    get_translation_fit(args.path_to_msd, args.limit, args.output_directory)
