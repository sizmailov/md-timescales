...
def plot_acorr_fit(path_to_fit_csv, path_to_csv_acorr, path_to_output_pdf):
    ...
    exp_order = {2: "tau_inertia_tensor_2_exp", 3: "tau_inertia_tensor_3_exp", 4: "tau_inertia_tensor_4_exp"}
    for order in range(2,5):
        with PdfPages(os.path.join(path_to_output_pdf, exp_order[order] + ".pdf")) as pdf:
            ...
            for ind in range(3):
                ...
                ax.set_title('inertia_tensor autocorrelation plot %d axis %d exp'%(inertia_axis, order))
